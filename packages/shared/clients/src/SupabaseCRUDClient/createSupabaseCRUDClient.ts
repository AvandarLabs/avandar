...
type AnySupabaseFilterableQuery = PostgrestFilterBuilder<
  any,
  any,
  any,
  any[],
...
>(options: {
  ...
  function _applyFiltersToSupabaseQuery<
    Query extends AnySupabaseFilterableQuery,
  >(query: Query, filters: FiltersByColumn<M["DBRead"]>): Query {
    let newQuery = query;
    ...
    crudFunctions: {
      ...
      getCount: async (params: {
        ...
        let query = dbClient.from(tableName).select("*", {
          count: "exact",
          head: true,
        }) as unknown as AnySupabaseFilterableQuery;
      ...
      getPage: async (params: {
        ...
        let query = dbClient
          .from(tableName)
          .select("*") as unknown as AnySupabaseFilterableQuery;
