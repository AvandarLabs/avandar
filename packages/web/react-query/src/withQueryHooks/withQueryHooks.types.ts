...
import type { UseQueryOptions, UseQueryResultTuple } from "../useQuery";
import type {
  CRUDClientModelSpec,
  ModelCRUDClient,
  ServiceClient,
 ...
 */
export type FnNameReturningPromise<T extends object> = Extract<
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ConditionalKeys<T, AnyFunctionWithSignature<[any], Promise<any>>>,
  string
>;
...
export type ClientWithCache<
  ClientWithQueries extends WithQueryHooks<
    ServiceClient,
    FnNameReturningPromise<ServiceClient>,
    FnNameReturningPromise<ServiceClient>
  >,
> = ClientWithQueries & {
  /**
...
> = WithLogger<
  WithQueryHooks<
    FullClient,
    Exclude<
      FnNameReturningPromise<FullClient>,
      DefaultMutationFnName | FnNameReturningPromise<ExtendedMutationsClient>
    >,
    Exclude<
      FnNameReturningPromise<FullClient>,
      DefaultQueryFnName | FnNameReturningPromise<ExtendedQueriesClient>
    >
  >
>;
*/
