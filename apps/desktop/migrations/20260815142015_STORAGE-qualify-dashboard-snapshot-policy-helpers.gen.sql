-- Generated from supabase/migrations/20260815142015_STORAGE-qualify-dashboard-snapshot-policy-helpers.sql by
-- apps/desktop/scripts/gen-sqlite-migrations/. Do not edit by hand
-- unless the matching `needs hand-edit` warning calls for it.
-- Schema-shape statements emitted: 0
-- Statements dropped (RLS/funcs/triggers/data/etc.): 20
