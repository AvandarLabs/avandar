...
1. Edit the scaffold to match patterns from `CsvFileDataset`, `OpenDataDataset`, and `Dataset`.
2. Add or refine parsers.
3. Fix the generated client to use `AvaSupabase.DB` and `createUsableServiceClient(...)`.
