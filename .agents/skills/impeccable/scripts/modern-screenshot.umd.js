  ...
  function bt(e, t) {
    ...
    ((o.width = Math.floor(r * i)),
      ...
      s &&
        ...
        : o.width > s ? ((o.height *= s / o.width), (o.width = s))
        : ((o.width *= s / o.height), (o.height = s))));
      ...
      if (i && a && I(e) && (V(e) || H(e))) {
        ...
        const p = (d = h.get("text-transform")) == null ? void 0 : d[0],
          ...
          b =
            E ?
              (w) => {
                (p === "uppercase" ? (w = w.toUpperCase())
                : p === "lowercase" ? (w = w.toLowerCase())
                : p === "capitalize" &&
...
`),
  ...
  function oe(e, t = []) {
    for (const r of Array.from(e))
      Ke(r) ? t.push(...oe(r.cssRules))
      : "cssRules" in r ? oe(r.cssRules, t)
      : t.push(r);
    return t;
  }
