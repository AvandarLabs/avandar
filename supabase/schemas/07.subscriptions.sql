...
-- Owner may read own billing row; members may read their workspace subscription.
--------------------------------------------------------------------------------
create policy "User can select subscriptions they own or for their workspace" on public.subscriptions for
select
