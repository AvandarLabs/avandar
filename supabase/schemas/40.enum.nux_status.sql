 ...
 *  tutorial is neither finished nor dismissed. Read it as "offered", not as
 *  "actively touring". Writing it on the "Not now" path too is what makes the
 *  invite show once.
 *
 ...
 *
 * `dismissed` - The user explicitly dismissed the checklist. Only the restart
 *  control on the profile page brings it back.
 *
