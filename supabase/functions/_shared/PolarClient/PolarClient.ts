import { getPolarAccessToken } from "@sfn/_shared/PolarClient/getPolarAccessToken.ts";
import { getPolarServerType } from "@sfn/_shared/PolarClient/getPolarServerType.ts";
