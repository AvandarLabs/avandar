-- Hide `draft` dashboards from readers who cannot edit them.
--
...
-- included, for a dashboard the client refuses to open. The rule the product
-- always meant is now enforced in the database: past the owner and settings
-- admin short-circuits, a draft requires `editor` on the resource.
