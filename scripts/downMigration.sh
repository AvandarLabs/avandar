...
#   supabase/migrations/ and then runs `yarn db:reset` to restart
...
usage() {
  ...
  echo "Deletes the most recent Supabase migration and runs 'yarn db:reset'."
