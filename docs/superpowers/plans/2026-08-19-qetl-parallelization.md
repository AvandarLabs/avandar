...
`.svg` / `.mmd` at the worktree root. Regenerated 2026-08-19 after S3·9
landed on impl. In flight: Case Manager chat on impl. F
(`feat/qetl-column-projection`) and chat concept aliases are merged.
...
flowchart TD
  ...
  F["<b>✓ F · Column projection</b><br/>merged into impl"]
  CALIAS["<b>✓ Chat concept aliases</b><br/>merged into impl"]
  ...
  S9["<b>✓ S3·9 · Rehearsal</b><br/>County queryable in explorer"]
  CM["<b>► Case Manager chat</b><br/>on impl · ontology via chat"]
  ...
  LEGEND["<b>QETL work DAG</b> · 2026-08-19<br/><i>feat/qetl-impl · F and chat concept aliases merged; Case Manager chat in flight</i><br/><br/><b>green ✓</b> · landed on impl<br/><b>amber ►</b> · kicked off / in flight<br/><b>blue</b> · still to do, not demo-blocking<br/><b>grey dashed</b> · skipped / punted / leftover cleanup<br/><b>dotted</b> · optional, not in this demo"]
  ...
  class M,A,B,C,CHAT,S4a,S4b,MB,P,G,S5,S8,IA,IB,IC,S6,S9,F,CALIAS done
  class CM now
  class D seq
