...
import "@/index.css";
import { configureBackgroundJobs } from "@background-jobs";
...
// Wire the background-jobs library's notifier to Mantine notifications
// and hydrate any persistent jobs left over from a previous tab. Errors
// are swallowed: a background-jobs init failure must never block the
// app from booting.
