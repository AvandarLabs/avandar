...
import css from "@/views/GisApp/shell/MapTopBar/MapOutputActions.module.css";
...
export function MapOutputActions(props: Props): ReactNode {
  const { t } = useLingui();
  return (
    <>
      <BasemapControl {...props} />
      <ViewsMenu {...props} />
      <ShareResourceButton
        resourceName={props.name}
        resourceType="map"
        resourceId={props.avaMapId}
        size="compact-sm"
      />
