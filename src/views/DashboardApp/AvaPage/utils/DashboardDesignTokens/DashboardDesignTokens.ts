...
function _getDashboardDesignTokens(
  options: Readonly<{
 ...
 */
function useDashboardThemeOptions(): Array<{
 ...
 * from a React component / hook.
 */
function useDashboardTypographyOptions(): Array<{
...
/** Resolves dashboard theme tokens and translated editor options. */
export const DashboardDesignTokens = {
  /** Returns design tokens for the selected theme and typography. */
  get: _getDashboardDesignTokens,
  /** Returns translated dashboard theme options. */
  useThemeOptions: useDashboardThemeOptions,
  /** Returns translated dashboard typography options. */
  useTypographyOptions: useDashboardTypographyOptions,
};
