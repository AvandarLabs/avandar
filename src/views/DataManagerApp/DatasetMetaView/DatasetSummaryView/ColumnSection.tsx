...
import css from "@/views/DataManagerApp/DatasetMetaView/DatasetSummaryView/ColumnSection.module.css";
...
export function ColumnSection({
  ...
  return (
    <section
      ref={setRefs}
      id={buildColumnSectionId(columnName)}
      className={css.section}
    >
      <Stack gap="sm">
        <Group gap="sm" align="baseline" wrap="nowrap">
          <Text component="h4" className={css.name}>
            {columnName}
          </Text>
          <Text className={css.type}>
