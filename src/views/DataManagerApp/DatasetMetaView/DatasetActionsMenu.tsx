 ...
 *
 * Delete lives in this menu rather than as a filled red button at the foot of
 * the page: making the most destructive action the largest and lowest thing
 * on a scrolling page is backwards twice over.
 */
