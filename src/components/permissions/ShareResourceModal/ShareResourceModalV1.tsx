...
/**
 * Legacy four-mechanism share modal preserved as the flag-off rendering
 * path for `SHARE_MODAL_V2`. Body is intentionally a verbatim copy of the
 * previous `ShareResourceModal` implementation — do not refactor.
 */
export function ShareResourceModalV1({
  resourceName,
  resourceType,
  resourceId,
  onClose,
