/**
 * Maximum rejected rows DuckDB stores per CSV scan (see DuckDbClient docs).
 */
 ...
 */
/**
 * Sniff+load cycles: quote inference, relaxed strict, cleared column types,
 * rejects.
 */
export const MAX_CSV_PARSE_ATTEMPTS = 5;

/**
 * Default double-quote when sniff reports `(empty)` and rejects indicate
 * mis-split rows.
 */
