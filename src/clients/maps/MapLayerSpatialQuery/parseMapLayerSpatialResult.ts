...
function _parseMatchDiagnostics(
  ...
  const countKeys = [
    "matchedSourceKeyCount",
    "unmatchedSourceKeyCount",
    "unmatchedBoundaryCount",
    "duplicateBoundaryKeyCount",
  ...
  const sampleKeys = [
    "unmatchedSourceKeySamples",
    "duplicateBoundaryKeySamples",
    "ambiguousSourceKeySamples",
  ] as const;
...
export function parseMapLayerSpatialResult(
