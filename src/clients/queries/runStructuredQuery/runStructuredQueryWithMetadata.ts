 ...
 * client, resolving dataset and entity sources, and returns the result
 ...
 * source-resolution branches. Callers that do not record analytics should use
 * {@link runStructuredQuery}, which drops the metadata so a plain result stays
 * a plain result at the call site.
 */
