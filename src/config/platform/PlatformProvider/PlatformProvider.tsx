...
const PlatformContext = createContext<PlatformImpls | undefined>(undefined);
...
export function PlatformProvider({
  ...
  const impls = useMemo<PlatformImpls>(() => {
    ...
    // through `PlatformRegistry.getImpls()`. Synchronous during render so any
    // descendant component / module that fires on mount sees a
    // populated registry.
    PlatformRegistry.setImpls(resolved);
    return resolved;
  }, [platformType]);
