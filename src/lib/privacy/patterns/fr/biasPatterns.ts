 ...
 *
 * Per the chat-interactive-workflows spec (Phase 0), the v1 ship is
 ...
 * Phase 2 + the advisor review have signed off. Until then,
 * `detectBias` falls back to English-only patterns and French-locale
